...
const STATS = [
  { end: 10,   suffix: "+", label: "Years of Experience",    sub: "in SA construction" },
  { end: 150,  suffix: "+", label: "Projects Completed",     sub: "across the Western Cape" },
  { end: 9500,suffix: "+", label: "Tests Conducted",        sub: "cube, slump & NDT" },
